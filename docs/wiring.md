...
| **STM32F401RE** | `PA4` (GPIO Output) | **DRV8825 Driver** | `DIR` Pin | Toggles directional rotation polarity (High/Low) |
| **STM32F401RE** | `PB4` (GPIO Output) | **DRV8825 Driver** | `STEP` Pin |Generates high-frequency step pulse clocks  |
